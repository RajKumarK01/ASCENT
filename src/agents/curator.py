...
def _fetch_microsoft_learn(cert_id: str):
    """Fetch Microsoft Learn module references via MCP or curated synthetic refs."""
    # In foundry mode with MCP available, this calls:
    ...
    ml_refs = {
        ...
        "AZ-305": [
            ...
            Citation(
                source="https://learn.microsoft.com/en-us/training/paths/design-identity-governance-monitor-solutions/",
                snippet="Microsoft Learn: Design identity, governance, and monitoring solutions — core AZ-305 architect skill areas."
            ),
        ],
        "AZ-400": [
            Citation(
